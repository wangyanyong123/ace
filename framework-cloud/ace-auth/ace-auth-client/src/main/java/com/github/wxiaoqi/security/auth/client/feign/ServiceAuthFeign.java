...
public interface ServiceAuthFeign {
    ...
    @RequestMapping(value = "/client/getExtrnalUser", method = RequestMethod.POST)
	ObjectRestResponse<ExternalUserVo> getExtrnalUser(@RequestParam("appId") String appId);

    @RequestMapping(value = "/client/getExtrnalUserMenu", method = RequestMethod.POST)
