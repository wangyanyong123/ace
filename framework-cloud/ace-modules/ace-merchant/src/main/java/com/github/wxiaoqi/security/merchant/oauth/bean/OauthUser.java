package com.github.wxiaoqi.security.merchant.oauth.bean;
...
public class OauthUser extends User implements UserDetails {
    ...
    public OauthUser(String id, String username, String password, String name, String tenantId,String userType, Collection<GrantedAuthority> authorities) {
