...
public interface ToolFegin {
	...
	@RequestMapping(value = "/aliPay/aliAppPay",method = RequestMethod.POST)
	ObjectRestResponse aliAppPay(@RequestBody @ApiParam GenerateUnifiedOrderIn generateUnifiedOrderIn) ;

	@RequestMapping(value = "/refund/refund",method = RequestMethod.POST)
    ObjectRestResponse refund(@RequestBody @ApiParam ApplyRefundTO applyRefundTO);

	@RequestMapping(value = "/wechatPay/pay",method = RequestMethod.POST)
    ObjectRestResponse wechatPay(@RequestBody @ApiParam GenerateUnifiedOrderIn generateUnifiedOrderIn);

	@RequestMapping(value = "/wechat/authorize",method = RequestMethod.POST)
    ObjectRestResponse<WechatOpenIdResult> authorize(@RequestBody @ApiParam WechatAuthorizeIn authorizeIn);

	@RequestMapping(value = "/pay/generateUnifiedOrder",method = RequestMethod.POST)
	ObjectRestResponse generateUnifiedOrder(@RequestBody @ApiParam GenerateUnifiedOrderIn generateUnifiedOrderIn);
}
