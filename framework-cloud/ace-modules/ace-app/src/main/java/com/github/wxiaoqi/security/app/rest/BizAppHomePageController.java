...
import com.github.wxiaoqi.security.app.vo.reservation.out.MyReservationVo;
 ...
 */
@RestController
@RequestMapping("bizAppHomePage")
@CheckClientToken
@CheckUserToken
@Api(tags="APP首页")
public class BizAppHomePageController {
    ...
    @ResponseBody
    @ApiOperation(value = "查询首页推荐商品---APP端", notes = "查询首页推荐商品---APP端",httpMethod = "GET")
