...
public interface SmsFeign {
    ...
    @RequestMapping(value = "/oss/uploadQRImg", method = RequestMethod.POST)
    public ObjectRestResponse<String> uploadQRImg(@RequestBody @ApiParam ExcelInfoVo excelInfoVo);
}
